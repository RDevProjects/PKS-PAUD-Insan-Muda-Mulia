                            ...
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="deskripsi_kegiatan" id="deskripsi_kegiatan"
                                        autocomplete="off"
                                        value="{{ old('deskripsi_kegiatan') ?? $kegiatan->deskripsi_kegiatan }}"
                                        class="py-1 px-3 block w-full text-sm border-gray-300 rounded focus:border-indigo-600 focus:ring-indigo-600 disabled:opacity-50 disabled:pointer-events-none">
                                ...
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <select name="kelas" id="kelas"
                                        ...
                                        <option value="A" @if (old('kelas') == 'A' || $kegiatan->kelas == 'A') selected @endif>Kelas A
                                        </option>
                                        <option value="B" @if (old('kelas') == 'B' || $kegiatan->kelas == 'B') selected @endif>Kelas B
                                        </option>
                                        <option value="C" @if (old('kelas') == 'C' || $kegiatan->kelas == 'C') selected @endif>Kelas C
                                        </option>
                                        <option value="D" @if (old('kelas') == 'D' || $kegiatan->kelas == 'D') selected @endif>Kelas D
                                        </option>
                                    </select>
                                    @error('kelas')
                                        <div class="text-red-500">{{ $message }}</div>
        ...
        <div class="lg:col-span-1">
            <div class="card h-full shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <p class="text-sm text-gray-600">Halaman ini adalah halaman Edit Data Kegiatan dari PAUD Insan Muda
                        Mulia.<br><br> Pada halaman ini, Anda dapat mengubah informasi kegiatan seperti Nama Kegiatan,
                        Deskripsi Kegiatan, Tanggal Kegiatan, dan Kelas. <br><br>Silakan ubah informasi yang
                        diperlukan dan
                        tekan tombol 'Submit' untuk menyimpan perubahan kegiatan ke dalam sistem. <br><br>Halaman ini
                        dirancang
                        untuk
