                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="date" name="tanggal_pengumuman" id="tanggal_pengumuman"
                                        autocomplete="off" value="{{ old('tanggal_pengumuman') ?? '' }}"
                                ...
                                <div class="col-span-6">
                                    <label for="isi_pengumuman" class="block text-sm font-medium text-gray-700">Isi
                                        Pengumuman</label>
                                    <textarea name="isi_pengumuman" id="isi_pengumuman" rows="5"
                                        class="py-1 px-3 block w-full text-sm border-gray-300 rounded focus:border-indigo-600 focus:ring-indigo-600 disabled:opacity-50 disabled:pointer-events-none">{{ old('isi_pengumuman') ?? '' }}</textarea>
        ...
        <div class="lg:col-span-1">
            <div class="card h-full shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <p class="text-sm text-gray-600">Halaman ini adalah halaman Tambah Data Pengumuman dari PAUD Insan Muda
                        Mulia.<br><br> Pada halaman ini, Anda dapat menginputkan data pengumuman baru seperti Tanggal
                        Pengumuman,
                        Judul Pengumuman, Isi Pengumuman, dan Kelas. <br><br>Silakan isi semua informasi yang
                        diperlukan dan
                        tekan tombol 'Submit' untuk menyimpan data pengumuman baru ke dalam sistem. <br><br>Halaman ini
                        dirancang
                        untuk
